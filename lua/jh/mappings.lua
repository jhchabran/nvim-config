...
map_normal_leader = {
  ...
  d = {
    name = "Debugger",
    q = { function() require('dap').terminate() end, "Quit debugging" },
  ...
  g = {
    ...
    d = {
      name = "Diffing",
      c = { "<cmd>Git diff HEAD~1<CR>", "current file against last commit" },
      ['C'] = { "<cmd>Git diff HEAD~1<CR>", "current branch against last commit" },
      d = { "<cmd>Git diff %<CR>", "current file against current branch" },
      ['D'] = { "<cmd>Git diff<CR>", "current branch" },
      m = { "<cmd>Git diff main %<CR>", "current file against main branch" },
      ['M'] = { "<cmd>Git diff main<CR>", "current branch against main branch" },
    },
